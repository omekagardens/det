# Deep Existence Theory (DET) v6.2 Release
...
- **`src/`**: Core simulation source code (v6.2).
- **`docs/`**: Comprehensive theory cards and technical reports.
- **`results/`**: Generated plots and test reports from the v6.2 run.
...
3. Explore the theory: Read `docs/det_theory_card_6_2.md`
