"""
DET v6_2 1D Collider - Minimal Reference Implementation
======================================================

This is a minimal 1D implementation of the DET v6_2 theory card for testing
...
def run_full_test_suite():
    ...
    print("="*70)
    print("DET v6_2 1D COLLIDER - FULL TEST SUITE")
    print("="*70)
